...
<head>
<meta charset="utf-8">
<title>KimMint POD | About Us</title>
...
<body ng-app="Home" ng-controller="Homcontroller">
			...
			<div class="collapse navbar-collapse justify-content-between px-lg-3"
				...
				<div class="navbar-nav m-auto py-0">
					<a href="/Home" class="nav-item nav-link "><i
						...
						class="nav-item nav-link active"><i class="fas fa-info-circle"></i>
	...
	<h2 class="m-auto text-center p-5 m-5">PAGE WILL BE AVAILABLE</h2>
