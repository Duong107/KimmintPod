			...
			<div class="collapse navbar-collapse justify-content-between px-lg-3"
				...
				<div class="navbar-nav m-auto py-0">
					<a href="/Home" class="nav-item nav-link "><i
						...
						class="nav-link nav-item active"><i class="fas fa-mail-bulk"></i>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 m-auto"
					ng-repeat="i in blogs|orderBy : '-dateCre' |limitTo:5:0">
					<div class="position-relative">
						<div
							...
							<!-- day of date upload -->
							<h4 class="font-weight-bold mb-n1">{{i.dateCre|date : 'dd'}}</h4>
							<!-- month of date upload -->
							<small class="text-white text-uppercase">{{i.dateCre|date
								: 'MMM'}}</small>
						</div>
					</div>
					<div class="shadow rounded  bg-secondary mb-2"
						style="padding: 30px;">
						<div class="d-flex mb-3">
							<div class="d-flex align-items-center">
								<img class="rounded-circle" style="width: 40px; height: 40px;"
									src="/img/user.jpg" alt=""> <a class="text-muted ml-2"
									href="">{{i.id_User | uppercase}}</a>
							</div>
							<div class="d-flex align-items-center ml-4">
								<i class="far fa-bookmark text-primary"></i> <a
									class="text-muted ml-2" href="/Home/Product">POD SYSTEM</a>
							</div>
						</div>
						<h4 class="font-weight-bold mb-3">{{i.title}}</h4>
						<p>{{i.subj}}</p>
						<a
