...
<body ng-app="MyApp">
	<div ng-controller="Mycontroller">
				...
				<div
					...
					<div class="navbar-nav m-auto py-0">
						<a href="/Home" class="nav-item nav-link "><i
							...
							About</a> <a href="/Home/Product" class="nav-item nav-link active"><i
						...
						<div class="collapse justify-content-between px-lg-3" id="user">
							<div class="navbar-nav m-auto py-0">
								<a href="/Home/User/Profile" class="nav-item nav-link"> <i
									...
									href="/Home/Contract" class="nav-item nav-link text-danger"><i
					...
					<a href="/Home/Cart" class="btn py-2 px-4 d-none d-lg-block"
						...
						href="/Home/Login"
						class="btn btn-primary py-2 px-4 ml-2 d-none d-lg-block"
						id="login">LOGIN</a> <a ng-if="islogin" href="/Home/User"
		...
		<div class="col-3 rounded bg-secondary position-absolute collapse"
			id="carthover"
			style="right: 10px; box-shadow: 0 5px 5px; z-index: 1;">
			<h6 class="mt-3">
		...
		<div class="container-fluid pt-5 "
			...
			<div class="container">
				<div class="text-center pb-2">
					<h1 class="mb-4">All PRODUCTS <b id="countproduct"></b></h1>
				</div>
				<div class="row ABC">
					<div class="float-start col-12 col-md-6 ">
						<select name="" class="col-12 mb-3 form-control" ng-model="countSelector" ng-change="changeCount(countSelector)" id="selectrange">
							<option value="">Sort by : Featured</option>
							<option value="-amount">Sort by : Selling</option>
							<option value="nic_Pro">Sort by : %Salnic</option>
							<option value="ml_Pro">Sort by : ML</option>
							<option value="name_Pro">Sort by : Name A-Z</option>
							<option value="-name_Pro">Sort by : Name Z-A</option>
							<option value="-price_Pro">Sort by : High To Low Price</option>
							<option value="price_Pro">Sort by : Low To High Price</option>
						</select>
					</div>

					<div class="float-end col-12 col-md-6 d-flex h-100">
						<input class="form-control col-9 col-md-10" id="searchbox" ng-model="keyword"
							type="search" placeholder="keywords" aria-label="keywords">
						<button class="btn btn-primary col-3 col-md-2" type="submit">Search</button>
					</div>
					<!-- Product Hot Start -->
					<div class="col-lg-3 col-md-6 col-6"
						ng-repeat="i in products| limitTo:8:numpage | orderBy:selectValue| filter:keyword">
						<div
							class="team card position-relative overflow-hidden border-0 mb-5">
							<img class="card-img-top" ng-src="{{i.image_Pro}}"
								alt="{{i.image_Pro}}">
							<div class="card-body text-center p-0">
								<div
									class="team-text d-flex flex-column justify-content-center bg-secondary">
									<h5 class="font-weight-bold">{{i.name_Pro}}</h5>
									<span>{{i.nic_Pro}} %NIC</span>
								</div>
								<div
									class="team-social d-flex align-items-center justify-content-center bg-primary">
									<button class="col-6 btn btn-secondary h-100" type="button"
										ng-value="{{i.id_Pro}}" onclick="addtocart(this)">Add
										To Cart</button>
									<a href="/Home/Product/Show?prod={{i.id_Pro}}" class="col-6 h-100 btn btn-secondary text-center"
					...
					<nav aria-label="..." class="col-12">
						<div class="d-flex col-4 m-auto">
							<button type="button" class="btn btn-primary col-6 m-auto page-link" ng-click="changepage(-8)">Previous</button>
							<button type="button" class="btn btn-primary col-6 m-auto page-link" ng-click="changepage(8)">Next</button>
						</div>
					</nav>
				</div>
			</div>
				...
				<div class="col-lg-7 col-md-6">
					<div class="row">
						<div class="col-md-6 mb-5">
							...
							<p>
								<i class="fa fa-map-marker-alt mr-2"></i>537/12 Nguyen Oanh,
								P17, Go Vap, HCM CITY
							</p>
							<p>
